!function() {
    ...
    function Pe(e, a) {
        var t = void 0;
        ge[e.accountData.analyticsID] && (t = function(e, a) {
            var t = Se(a);
            if (t)
                return function(e, a) {
    ...
    var Ee = "hidden"in document ? function() {
    ...
    function Le(e, a, t) {
        ...
        e.playlistItemData.mediaId = Ie(l),
        e.playerData.playerSize = function(e) {
            ...
            /\d+%/.test(a.width || t) && a.aspectratio ? {
                ...
                width: t,
                height: n
            } : Ce(e.getContainer(), "jw-flag-audio-player") ? {
                bucket: Re,
                width: t,
                height: n
            } : 0 === t ? {
        ...
        o = a,
        d = t,
        -1 === Me.indexOf(o) && (i.meta.eventPreAbandonment = c(o, d))
    }
    var Oe = {
        prs: function(e) {
      ...
      , Ne = {
        ...
        vpb: function(e) {
            if ("object" == typeof e.ads.headerBiddingData.bidders)
                return u(e.ads.headerBiddingData.bidders)
        },
        vcb: function(e) {
        ...
        rtp: function(n) {
            if ("object" == typeof n.inference.result) {
                var e = u(["predictions", "segments"].reduce(function(e, a) {
    ...
    Ne.vsrid = function(e) {
        return (we(e.playlistItemData.item, "jwpseg") || {}).request_id || null
    }
    ;
    var qe = {
        dnt: function(e) {
    ...
    var Fe = {
      ...
      , _e = {
        fed: function(e) {
            return -1 !== Ue.indexOf(e.meta.lastEvent) ? e.related.feedId : he(e.playlistItemData.item)
        },
        fid: function(e) {
            return -1 !== Ue.indexOf(e.meta.lastEvent) ? e.related.feedInstanceId : ke(e.playlistItemData.item)
        },
        ft: function(e) {
    ...
    ,
    na.psd = function(e) {
        return -1 !== Ue.indexOf(e.meta.lastEvent) ? e.related.pinSetId : De(e.playlistItemData.item)
    }
    ,
    na.vh = function(e) {
    ...
    na.vs = function(e) {
        ...
        return function(e, a, t) {
            ...
            if (Ce(e.getContainer(), "jw-flag-audio-player"))
                return 6;
            var i = 0 | n.width
              , o = 0 | n.height;
    ...
    ;
    var ra = M({}, Qe, Fe, qe, na, ea, _e, Ge, Ne, Oe, We);
    function ia(e, i) {
        var a = ve.events[e]
          , t = a.parameterGroups.reduce(function(e, a) {
            return e.concat(ve.paramGroups[a].members)
    ...
    var da = function(e, a) {
      ...
      , ca = {
        main: "thetvapp.to/v1",
        main_fallback: "ping-origin-thetvapp.to/v1",
        meta: "ping-meta-thetvapp.to/v1"
    }
      , ua = function() {
        function r(e, a, t, n) {
            da(this, r),
            ...
            this.host = n,
            this.paramData = M({}, t),
            de in this.paramData || (this.paramData[de] = {
                code: de,
                value: e
            }),
        ...
        return la(r, [{
            ...
            get: function() {
                var a = this.encodedParameters
                  , t = Object.keys(a);
                return [oe, de].forEach(function(e) {
                    var a = t.indexOf(e);
                    -1 !== a && (t.splice(a, 1),
                    t.unshift(e))
                }),
    ...
    function ga(e) {
        ...
        (e.trackingState.pageLoaded = t) || (e.trackingState.boundFlushQueue = va.bind(null, e),
    ...
    function Da(e) {
        ...
        e.bidders.forEach(function(e) {
            ...
            U.forEach(function(e) {
                var a;
                "result" === e ? n.result = I[t[e]] : M(n, void 0 !== t[e] ? ((a = {})[e] = t[e],
                a) : void 0),
    ...
    var Ca = {
        ...
        adTime: function(e, a) {
            ...
            !n || t.position > t.duration || (!function(e, a, t) {
                var n = Pa(a, t)
                  , r = e.ads.pingLimiters.visibleEvent.canSendPing(pe) || e.ads.pingLimiters.visibleEvent.canSendPing(se);
            ...
            i.visibleEvent.canSendPing(pe) && r.totalVisibleSeconds >= Math.floor(t.duration / 2) && (ka(e, pe, "clienta"),
            i.visibleEvent.setPingSent(pe)),
            i.visibleEvent.canSendPing(se) && 2 <= r.maxConsecutiveVisibleSeconds && (ka(e, se, "clienta"),
    ...
    function Aa(i) {
        ...
        e.on("adClick adRequest adMeta adImpression adComplete adSkipped adError adTime adBidRequest adBidResponse adStarted adLoaded adViewableImpression adBreakEnd", function(e) {
            ...
            i.ads.adPlaybackTracking = M({}, S)),
            n = e,
            -1 === C.indexOf(n.type) && wa(i, e),
            e.type in Ca ? Ca[e.type](i, e) : -1 === E.indexOf(e.type) && ka(i, P[e.type], "clienta")
        })
    }
    function xa(e) {
        var a, t;
    ...
    function Na(f, m) {
        return function(e) {
            ...
            t = e.cardVisible,
            a === Ba && t ? Ma : a === Va && t ? Ra : a === Ba || a === Va ? null : a);
            p && (n = p,
            i = m,
            o = (r = e).cueId,
            d = r.cardId,
            ...
            u = r.projectName,
            s = r.projectVersion,
            i.interactive.eventId = L(12),
            i.interactive.eventName = Oa[n],
            i.interactive.interactionType = Ga[La],
    ...
    function qa(t) {
        t.external.playerAPI.on("ready", function() {
            var e, a;
            (a = (e = t).external.playerAPI.getPlugin("interactive")) && a.on && (a.on(Ma, Na(Ma, e)),
            a.on(Ra, Na(Ra, e)),
            a.on(ja, Na(ja, e)),
            a.on(Ba, Na(Ba, e)),
            a.on(Va, Na(Va, e)))
    ...
    var Fa = ["predictions", "segments", "decisionThresholds"];
    var Ua = 1e3;
    function _a(e) {
    ...
    function Ha(u, s) {
        return function(e) {
            ...
            s === Ka && (g(u, z),
            "flash_adaptive" === v(r) ? !u.meta.playbackSent && n.segmentReceived && (u.meta.playbackSent = !0,
            n.segmentReceived = !1,
            Wa(u)) : u.meta.playbackSent || (u.meta.playbackSent = !0,
            Wa(u)))
        }
    }
    function $a(e) {
    ...
    function Za(e, a, t) {
        ...
        g(e, me),
        e.meta.eventPreAbandonment = c(a, "error"),
    ...
    function it(v) {
        ...
        .bind(null, v), t = function(e, a) {
            ...
            t && t === Ie(a.item) && (e.playerData.lastErrorCode[J] = a.code,
            ka(e, "paf", "error"))
        }
        .bind(null, v);
        ...
        g.on("playlistItem", function(e) {
            ...
            r && (a.mediaId = Ie(r),
            Pe(v, r)),
            a.ready && (v.meta.playbackTracking.posterVideoThumbnail = Te(e.item),
            t = v,
            n = a.ready,
        ...
        g.on("time", function(e) {
            ...
            if (n)
                if (v.meta.seekTracking.dragStartTime)
                    ...
                    p);
                    if (Ja(v, t.playedSecondsTotal, f, 10),
                    Ja(v, t.playedSecondsTotal, f, 30),
                    Ja(v, t.playedSecondsTotal, f, 60),
                    t.playedSecondsTotal = t.playedSecondsTotal + f,
                    !0 === t.sendSetTimeEvents && (Xa(v, n, 3),
                    Xa(v, n, 10),
                    Xa(v, n, 30)),
                    r <= 0 || r === 1 / 0)
        ...
        g.on("visualQuality", function(e) {
            ...
            k = a,
            t && -1 === r.indexOf(n.reason) && ka(v, "vqc")
        }),
        g.on(o.join(" "), function() {
            v.ads.adBreakTracking && (v.ads.adBreakTracking.shouldTrack = !0)
        }),
        g.on("error", Za.bind(null, v, me)),
        g.on("setupError", Za.bind(null, v, fe)),
        ...
        g.on("captionsChanged", function(e) {
            0 !== e.track && 0 === v.playerData.captionsIndex && ka(v, ne),
        ...
        g.on("inference", function(e) {
            var t;
            t = e,
            v.inference.result = Fa.reduce(function(e, a) {
                return t[a] && (e[a] = t[a]),
                e
            }, {})
        }),
    ...
    function ot(e, a) {
        e.related.feedId = he(a),
        e.related.feedInstanceId = ke(a),
        e.related.feedType = we(a, "kind"),
        ...
        e.related.pinSetId = De(a.target),
        e.related.advanceTarget = Ie(a.target),
    ...
    function ct(t) {
        t.external.playerAPI.getPlugin && (t.external.playerAPI.on("ready", function() {
            ...
            e.on("nextClick", function(e) {
                a.related.nextShownReason && dt(a, e, Z)
            }),
            ...
            !function(a) {
                ...
                if (e.getPlugin) {
                    ...
                    t && t.on("click", function(e) {
                        a.sharing.shareMethod = ut[e.method] || ut.custom,
                        ka(a, $)
                    })
                }
            }(e)
    ...
    var ht = ["1", "yes", "true"];
    function kt(e, a) {
        return !0 === e || !!(t = a) && 0 <= ht.indexOf(t.toString());
        var t
    }
    var Dt = 0;
    function wt(e, a, t) {
        var n = a.sdkplatform ? parseInt(a.sdkplatform, 10) : V
          , r = e.getConfig()
          , i = (r || {}).advertising || {}
          , o = Dt += 1
          ...
          , l = kt(d, r.doNotSaveCookies)
          , c = void 0
          , u = void 0;
        if (l)
            yt && yt.removeItem("jwplayerLocalId");
        else {
            var s = function() {
                if (!yt)
                    return {
                ...
                try {
                    return yt.jwplayerLocalId = L(12),
                    {
                        localID: yt.jwplayerLocalId,
        ...
        var b, h, k, D, w, I, S, T, P, E, C, A, x = Math.random() <= pt;
        return {
            external: {
                playerAPI: e,
                div: t,
            ...
            k.autostart in R && (S.autostartConfig = R[k.autostart]),
            I && (S.relatedPluginFeedFile = I.recommendations || I.file),
            S),
